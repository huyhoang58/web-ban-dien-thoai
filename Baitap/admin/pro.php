...
if (isset($_POST["btn_update"])) {
    ...
    if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "gif" && $imageFileType != "jpeg") {
        ...
        if (move_uploaded_file($_FILES["hinhanh-update"]["tmp_name"], $target_file)) {
            ...
            $sql_update = "UPDATE `tbl_sanpham` SET `Ma_DanhMuc`= '" . $_POST["ma_dm"] . "',`Ten_SanPham`= '" . $_POST["title-update"] . "',`AnhSP`= '$target_file',`Gia`= " . $_POST["gia-update"] . ",`MoTa`= '" . $_POST["content-update"] . "',`SoLuong`= '" . $_POST["number-update"] . "' where Ma_SanPham = " . $_POST["id_sp"] . ";";
